...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DPq0MmFg.mjs");
...
const manifest = {
  "17ebbafaaa679a189568fd20d67f1940b1e32ede2029204290093c3eda1e892d": {
    ...
    importer: () => import("./sheets.functions-DVWqYG-_.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-v0dzu4GX.mjs").then((n) => n.D),
    import("./start-Bwh3aGU9.mjs"),
