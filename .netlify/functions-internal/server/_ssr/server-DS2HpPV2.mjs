...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CmYaqs3P.mjs");
...
const manifest = {
  "17ebbafaaa679a189568fd20d67f1940b1e32ede2029204290093c3eda1e892d": {
    ...
    importer: () => import("./sheets.functions-CDp6haNF.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-8vuZ9gUy.mjs").then((n) => n.D),
    import("./start-BxbrSDwO.mjs"),
