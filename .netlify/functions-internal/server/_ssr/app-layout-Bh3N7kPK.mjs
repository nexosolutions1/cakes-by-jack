...
import { B as Button, c as cn, a as BrandLogo, I as Input } from "./brand-logo-3iPsG8o9.mjs";
...
import { e as useAuth } from "./router-DrEiKWY7.mjs";
import { L as LoaderCircle, x as LogOut, y as LayoutDashboard, z as Store, p as ClipboardList, q as CalendarDays, W as Wallet, B as Boxes, F as FileText, G as Settings, i as ChefHat, H as PanelLeft, X } from "../_libs/lucide-react.mjs";
...
function AppSidebar({ perfil = "OWNER" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b border-sidebar-border px-3 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3", onClick: handleNav, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BrandLogo, { size: 40 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight group-data-[collapsible=icon]:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-base font-semibold tracking-tight text-chocolate", children: "Cakes by Jack" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.18em] text-rose-deep", children: "Confeitaria Artesanal" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { label: "Gestão", items: gestao, pathname, onNav: handleNav }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { label: "Operação", items: operacao, pathname, onNav: handleNav }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { label: "Sistema", items: sistema, pathname, onNav: handleNav }),
      isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { label: "Administração", items: adminItems, pathname, onNav: handleNav })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NexoSignature, {}) })
  ] });
}
function Group({
  label,
...
function AppLayout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen w-full bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppSidebar, { perfil: user.perfil ?? "OWNER" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 flex flex-wrap items-center gap-2 border-b border-border bg-background/85 px-3 py-2 backdrop-blur-md sm:gap-3 md:h-16 md:flex-nowrap md:px-8 md:py-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 flex-col leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display truncate text-lg font-semibold tracking-tight sm:text-xl md:text-2xl", children: title }),
          subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-xs text-muted-foreground md:text-sm", children: subtitle })
        ] }),
        actions && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-3 flex w-full items-center gap-2 md:order-none md:w-auto", children: actions }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-l pl-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden flex-col items-end leading-tight sm:flex", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: user.nome }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "h-4 text-[10px]", children: user.perfil })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 px-3 py-4 sm:px-4 sm:py-6 md:px-8 md:py-8", children })
    ] })
  ] }) });
}
export {
