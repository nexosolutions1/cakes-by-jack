...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DmgVCQKW.mjs");
...
const manifest = {
  "17ebbafaaa679a189568fd20d67f1940b1e32ede2029204290093c3eda1e892d": {
    ...
    importer: () => import("./sheets.functions-DKAuckJW.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CTVFEuqq.mjs").then((n) => n.D),
    import("./start-DvcWFMIW.mjs"),
